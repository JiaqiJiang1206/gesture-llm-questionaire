<template>
	<div class="body-container">
		<div class="body_button_container">
			...
			<button id="nextButton" @click="$emit('complete-body-record')" :style="{ display: ifSubmitButton }">
				提交录制
			</button>
		</div>
...
function toggleExersizeWebcam(event) {
	...
	function toggleButtonText() {
		if (webcamRunning.value === true) {
			...
			document.getElementById("exersizeWebcamButton").style.backgroundColor = "white";
